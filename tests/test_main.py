"""Application wiring: health probe, the 9-endpoint inventory, and event subscription."""
...
#: The 9 REST endpoints required by capstone PDF section 2.3, excluding /health.
EXPECTED_ENDPOINTS = {
    ("GET", "/api/tasks"),
...
def test_exactly_the_nine_required_rest_endpoints_are_routed(client: TestClient) -> None:
    """PDF section 2.3 specifies 9 REST endpoints. /health is infrastructure and excluded."""
